...
export default function PlanetaryWaypoints() {
  return (
    <section className="relative w-full h-screen px-6 flex items-center justify-center pointer-events-auto z-30 overflow-hidden pt-12 sm:pt-14 pb-8">
      ...
      <div className="w-full max-w-[90vw] md:max-w-[min(680px,46vw)] lg:max-w-[min(720px,47vw)] mx-auto flex flex-col items-center text-center gap-2 sm:gap-3 md:gap-5 -mt-3 sm:-mt-5 md:mt-6 lg:mt-10">
        ...
        <div className="flex flex-col items-center text-center gap-3 sm:gap-4 md:gap-6 font-orbitron w-full">
          ...
          <CosmicInteractiveParagraph
            ...
            className="w-full text-xs sm:text-sm md:text-[15px] lg:text-[16px] xl:text-[17px] text-slate-100/95 leading-[1.68] sm:leading-[1.72] md:leading-[1.8] audiowide-regular tracking-wide text-center"
            style={{
